...
export const BUILDINGS: Record<string, BuildingDefinition> = {
  ...
  "gateway-of-india": {
    ...
    sprites: {
      south: "/Building/mumbai/5x5gateway_of_india_south.png",
    },
    icon: "🏛️",
  ...
  "taj-hotel": {
    ...
    category: "mumbai_landmarks",
    footprint: { width: 10, height: 6 },
    sprites: {
      south: "/Building/mumbai/10x6taj_hotel_south.png",
    },
    icon: "🏨",
    supportsRotation: false,
  },
  "cst-station": {
    ...
    sprites: {
      south: "/Building/mumbai/12x10cst_station_south.png",
    },
    icon: "🚂",
    supportsRotation: false,
  },
  "bdd-chawl": {
    ...
    name: "BDD Chawl",
    category: "mumbai_landmarks",
    footprint: { width: 8, height: 4 },
    sprites: {
      south: "/Building/mumbai/8x4bdd_chawl_south.png",
    },
    icon: "🏘️",
    supportsRotation: false,
  },
  "marine-drive-apt": {
    ...
    footprint: { width: 4, height: 4 },
    sprites: {
      south: "/Building/mumbai/4x4marine_drive_apt_south.png",
    },
    icon: "🏢",
    supportsRotation: false,
  },
